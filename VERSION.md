...
last_update_by: LEAD (0.2.63 23/7: B86 fee-validation fix — gỡ ràng buộc sai phí/phí cài máy từ B45, đổi đúng thành phí bán≥phí mua ở cả 3 nơi. Gate typecheck 0 · build fresh · ST7/15/33 exit 0. Không migration. Chờ Mr.Long build installer+PV. — Trước: 0.2.60 20/7: B82 update-available race [H2b] PULL pattern + B83 isServerRole() marker file fallback — cả 2 do Mr.Long tự phát hiện khi test Production Validation 0.2.59. Gate typecheck 0 · vitest 289 · FULL ST1-44=0. Không migration. Chờ Mr.Long ship+PV. — Trước: 0.2.59-DEV 20/7: trường "Của ai" đối tác trên phiếu thu/chi + partnerText/listPartnersLite + B81 IN_USE danh mục + PF-11 ST24 rotted. Gate typecheck 0 · vitest 289 · FULL ST1-44=0 · playwright 3 ảnh form. Migration cashentry_partner_text (additive nullable + self-heal). Chờ Mr.Long ship. — Trước: 0.2.20 ship cả thể: fee-model rework sell-only + loại giao máy + Nhóm 1 UI + fix locale ngày. Gate: typecheck 0 · build 0 · vitest 253 · selftest FULL ST2-42 = 0 fail (rerun SẠCH sau mỗi cụm; ST42 HANDOVER mới). 3 migration mới (fee_type_dimension DROP phi_ban + fee_sell_quotes, warehouse_manager, handover_type) áp glb rỗng-tiền + seed handover types/perms/RENT verify tại DB. PF: fee-model build SAI lần đầu (loại phí đổi cả mua/cài/bán) → Mr.Long chỉnh → rework; ST40 test-data username 7 ký tự (tái lớp B26) → LEAD full-selftest bắt. Trước: 0.2.19 timeline+permsync.)
rule_break_count: 0
schema_version: 35
