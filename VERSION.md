...
last_update_by: LEAD (AUDIT rerun sạch: typecheck 0 · build 0 · vitest 238 · selftest 31 (import 6 entity) pass=47 fail=0 · QA-pair #9 REQUEST CHANGES → hardening (dry-run confirm + xlsx 0.20.3 vá CVE + row-cap) PASS)
rule_break_count: 0
schema_version: 21
