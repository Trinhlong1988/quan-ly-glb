...
current_version: 0.36.0-devicesale
...
last_update_by: LEAD (gate xanh: typecheck 0 · build 0 · vitest 240 · selftest full ST2-41 (đang chạy sau dọn nợ; #36 backup+mirror 16/16 chạy riêng PASS, #41 devicesale money-assert xanh) · migration `20260712210000_device_sale` đã áp glb (backup glb_pre_device_sale_20260712_145252.dump); `20260712220000_status_sold` áp glb khi ship (data-only INSERT ON CONFLICT).)
rule_break_count: 0
schema_version: 28
