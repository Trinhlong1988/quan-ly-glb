...
current_version: 0.30.0-review-r8r15
status: Reopen review đợt 2 (R8–R15) DONE + đóng exe 0.1.5. R8 form KH chọn đại lý + bộ đếm trạng thái toàn cục · R9 chọn NH liên kết ngay trong form đối tác (giữ nút nối tắt) · R10 Ngành nghề thành tab trong Cấu hình ngân hàng · R12 "% phí"→"Phí mua-cài máy-bán" · **R13 trạng thái Đối tác (Đã ký/Chưa ký/Đã hủy HĐ) + cột Địa chỉ** · **R14 danh mục trạng thái tùy biến dùng chung `StatusOption` (builtin khóa + thêm mới cho master-data: Bank/Customer/Partner/POS/HKD-MST) + trang cấu hình Trạng thái** · R15 dải tab dùng chung nền đậm (9 trang). Trước đó: R1–R7 (exe 0.1.4), #13/#14 (B24), PHASE_K.
last_update_ts: 2026-07-11
last_update_by: LEAD (AUDIT rerun sạch: typecheck 0 · build 0 · vitest 238 · selftest 32 (status catalog+partner) PASS 20/20 · selftest 3 (customer, sau fix assertion active+2) + 18 (approval) failures=0 · audit:protected 1643/5-anchor · audit:deferred 0 · exe 0.1.5 deploy feed+Desktop). 3 CMD_BUILD song song (CustomersPage / PosPage+DossierPage / 5-trang-tab) + LEAD BankConfigPage + infra.
rule_break_count: 0
schema_version: 22
