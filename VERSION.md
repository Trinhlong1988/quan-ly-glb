...
current_version: 0.32.0-review-r29r35
status: Reopen review đợt 4 (R29–R35) DONE + đóng exe 0.1.7. R29 nhãn gán máy công ty/khách · **R30 phí bán thực tế theo TID×thẻ (bảng tid_sell_fees, override niêm yết, nhập khi giao)** · R31 TK nhận tiền thành tab trong Nhân sự · R32 tab TID chưa giao có Thao tác · **R34 Duyệt hủy đa-entity (TID/POS/Khách/Nhân sự) — xóa mềm qua duyệt, Admin+Manager duyệt, mật khẩu khi duyệt** · R35 sắp lại tab Tài chính. Chờ: R33 màu nút · R27 kho.
last_update_ts: 2026-07-11
last_update_by: LEAD (gate xanh: typecheck 0 · build 0 · vitest 238 · selftest 33 phí-bán 15/15 · 34 duyệt-hủy 26/26 · 18 approval 31/31 · 32 status 20/20 · audit:protected 1692/5-anchor · audit:deferred 0. Migration glb đã áp (backup glb_pre_r30r34). Sub-agent deep-audit dừng do session-limit → LEAD manual audit (StaffPage clean, resolveFeeForTxn đúng, lưu ý IPC xóa cũ còn nhưng không có nút UI). 1 CMD_BUILD (4 trang gắn Yêu-cầu-hủy) + LEAD backend/engine/UI trung tâm.)
rule_break_count: 0
schema_version: 23
...
- **Chờ:** R33 màu nút thao tác đồng bộ (đang chốt scope với Mr.Long) · R27 Cấu hình kho.
