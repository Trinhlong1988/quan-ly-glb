...
current_version: 0.19.0-h2-core
status: H2-core (Quỹ + Phiếu thu/chi + Lợi nhuận MVP) ENGINEERING VALIDATED — chờ LEAD AUDIT + commit + tag. (H1 cashcat committed 9ead981.)
