...
Counter: B = 19. PF (process-failure) = 1. Last audit: 2026-07-10 (… P1.2 approval + B17 emit-trap/clobber + B18 TOCTOU tương tranh approval — phát hiện khi chuẩn bị G10 đa-client Postgres; + PF-01 sót auto-update do duyệt gộp; + B19 admin reset MK user khác không re-auth actor).
