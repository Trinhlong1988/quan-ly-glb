...
const api = {
  ...
  productList: (filter: unknown) => ipcRenderer.invoke('product:list', filter),
  productCreate: (input: unknown) => ipcRenderer.invoke('product:create', input),
  productUpdate: (id: number, input: unknown) => ipcRenderer.invoke('product:update', { id, input }),
  productDelete: (ids: number[], password: string) => ipcRenderer.invoke('product:delete', { ids, password }),
  productImport: (industryId: number, rows: unknown[]) => ipcRenderer.invoke('product:import', { industryId, rows }),
  billExplainGenerate: (input: unknown) => ipcRenderer.invoke('billExplain:generate', input),
  billExplainList: (filter: unknown) => ipcRenderer.invoke('billExplain:list', filter),
  billExplainDelete: (ids: number[], password: string) => ipcRenderer.invoke('billExplain:delete', { ids, password }),
  billExplainConfig: () => ipcRenderer.invoke('billExplain:config'),
  billExplainSetConfig: (input: unknown) => ipcRenderer.invoke('billExplain:setConfig', input),
  billExplainImportTemplate: () => ipcRenderer.invoke('billExplain:importTemplate'),
  billExplainResetTemplate: () => ipcRenderer.invoke('billExplain:resetTemplate'),
  billExplainExportTemplate: () => ipcRenderer.invoke('billExplain:exportTemplate'),
  billExplainOpenFile: (id: number) => ipcRenderer.invoke('billExplain:openFile', id),
  billExplainOpenFolder: () => ipcRenderer.invoke('billExplain:openFolder'),
  ...
  captureRegion: (opts?: { hideApp?: boolean }) => ipcRenderer.invoke('capture:region', opts),
  openScreenshotDir: () => ipcRenderer.invoke('capture:openDir'),
